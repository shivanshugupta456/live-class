      ...
      <div className='max-w-7xl mx-auto'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          <div className='relative'>
            <div className='bg-gradient-to-br from-blue-600 via-indigo-600 to-cyan-500 rounded-2xl p-8 shadow-2xl'>
          ...
          <div>
            <h2 className='text-4xl font-extrabold premium-title mb-6'>
              {APP_CONFIG.HOME_CONTENT.BENEFITS.HEADING.replace('{APP_NAME}', APP_CONFIG.APP_NAME)}

            </h2>
            <p className='text-xl premium-muted mb-8'>
